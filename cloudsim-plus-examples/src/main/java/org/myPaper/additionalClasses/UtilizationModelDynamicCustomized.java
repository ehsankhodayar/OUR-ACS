 ...
 */
public class UtilizationModelDynamicCustomized extends UtilizationModelAbstract {
    /**
     * Indicates whether the utilization model is readonly.
     * It's set to true when using the
     * {@link #UtilizationModelDynamicCustomized(UtilizationModelDynamicCustomized) copy constructor}
     ...
     */
    private Function<UtilizationModelDynamicCustomized, Double> utilizationUpdateFunction;
    ...
    /**
     * @see #setUtilizationUpdateSchedulingInterval(double)
     * @see #getUtilizationUpdateSchedulingInterval()
     */
    private double utilizationUpdateSchedulingInterval;

    /**
     * Creates a UtilizationModelDynamicCustomized with no initial utilization.
     ...
     * @see #setUtilizationUpdateFunction(Function)
     */
    public UtilizationModelDynamicCustomized() {
     ...
     */
    public UtilizationModelDynamicCustomized(final Unit unit) {
        this(unit, 0);
    }

    /**
     * Creates a UtilizationModelDynamicCustomized that the initial resource utilization
     ...
     */
    public UtilizationModelDynamicCustomized(final double initialUtilizationPercent) {
     ...
     */
    public UtilizationModelDynamicCustomized(final Unit unit, final double initialUtilization) {
     ...
     */
    public UtilizationModelDynamicCustomized(final Unit unit, final double initialUtilization, final double maxResourceUtilization) {
        super(unit);
        this.readOnly = false;
        ...
        this.setUtilizationUpdateSchedulingInterval(0);

        utilizationUpdateFunction = modelInstance -> modelInstance.currentUtilization;
    }

    /**
     * A copy constructor that creates a read-only UtilizationModelDynamicCustomized based on a source object.
     *
     * @param source the source UtilizationModelDynamicCustomized to create an instance from
     */
    protected UtilizationModelDynamicCustomized(final UtilizationModelDynamicCustomized source) {
    ...
    /**
     * A copy constructor that creates a UtilizationModelDynamicCustomized based on a source object.
     *
     * @param source             the source UtilizationModelDynamicCustomized to create an instance from
     * @param initialUtilization the initial resource utilization (in the same unit of the given UtilizationModelDynamicCustomized instance)
     */
    public UtilizationModelDynamicCustomized(final UtilizationModelDynamicCustomized source, final double initialUtilization) {
    ...
    public double getUtilization(final double time) {
        ...
        if (getTimeSpan() >= getUtilizationUpdateSchedulingInterval()) {
            /*
            ...
            */
            currentUtilization = utilizationUpdateFunction.apply(new UtilizationModelDynamicCustomized(this));
     ...
     * @return
     */
    public final UtilizationModelDynamicCustomized setMaxResourceUtilization(final double maxResourceUsagePercentage) {
     ...
     *
     * <p>Such a function must require one {@link UtilizationModelDynamicCustomized} parameter and return the new resource utilization.
     * When this function is called internally by this {@code UtilizationModel},
     * it receives a read-only {@link UtilizationModelDynamicCustomized} instance and allow the developer using this {@code UtilizationModel} to
     ...
     * @return
     */
    public final UtilizationModelDynamicCustomized setUtilizationUpdateFunction(final Function<UtilizationModelDynamicCustomized, Double> utilizationUpdateFunction) {
        this.utilizationUpdateFunction = Objects.requireNonNull(utilizationUpdateFunction);
        return this;
    }

    /**
     * Sets the utilization update scheduling interval. For example, if the interval is equal to 300, the resource
     * utilization is allowed to be updated every 300 seconds (or 5 minutes).
     *
     * @param interval the allowed interval
     * @see #getUtilizationUpdateSchedulingInterval()
     */
    public void setUtilizationUpdateSchedulingInterval(final double interval) {
        if (interval < 0) {
            throw new IllegalStateException("The interval could not be less than zero!");
        }

        utilizationUpdateSchedulingInterval = interval;
    }

    /**
     * Gets the utilization update scheduling interval.
     *
     * @return the utilization update scheduling interval
     * @see #setUtilizationUpdateSchedulingInterval(double)
     */
    public double getUtilizationUpdateSchedulingInterval() {
        return utilizationUpdateSchedulingInterval;
    }
}
